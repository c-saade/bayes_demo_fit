...
The _sampling_ function returned a _stanfit_ object for which the _print_ method is very informative:

```{r}
print(fit_obs)
```

Printing the stanfit yields summary statistics for all parameters.
